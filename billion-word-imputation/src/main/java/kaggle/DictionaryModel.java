...
public class DictionaryModel implements Serializable {
    private static final Logger logger = LogManager.getLogger(DictionaryModel.class);

    private static final long serialVersionUID = 1648607850532636804L;
    private DictionaryNGramCounts nGramCounts;
    ...
    public DictionaryModel(int n) {
        nGramCounts = new DictionaryNGramCounts(n);
    }
